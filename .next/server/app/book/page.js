...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 3279)), "/home/tien/Desktop/node/js-dev-test/Book_app_NextJS/src/app/book/page.jsx"],
    ...
    manifest: undefined
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 3584)), "/home/tien/Desktop/node/js-dev-test/Book_app_NextJS/src/app/layout.jsx"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 2819))).default(props))],
    apple: [],
    openGraph: [],
    ...
    const pages = ["/home/tien/Desktop/node/js-dev-test/Book_app_NextJS/src/app/book/page.jsx"];
...
;// CONCATENATED MODULE: ./src/components/bookList.jsx
...
function BookList({ bookArray }) {
    ...
    var a = 1;
    bookArray.forEach((i)=>{
        rows.push(/*#__PURE__*/ jsx_runtime_.jsx(BookItem, {
            book: i
        }, a++));
    });
...
/* harmony default export */ const bookList = (BookList);

// EXTERNAL MODULE: ./src/services/fetchServices/fetchData.js
var fetchData = __webpack_require__(6352);
;// CONCATENATED MODULE: ./src/app/book/page.jsx
...
async function BookListPage() {
    ...
    if (bookArray.length === 0) {
        bookArray = await (0,fetchData.Get)();
    }
    return /*#__PURE__*/ jsx_runtime_.jsx("div", {
        className: "flex-col items-center justify-between p-5",
        children: /*#__PURE__*/ jsx_runtime_.jsx(bookList, {
            bookArray: bookArray
        })
    });
}
...
async function Get(id) {
    try {
        var defind_url = "";
        if (id === undefined) defind_url = "http://localhost:3001/book";
        else defind_url = `http://localhost:3001/book/${id}`;
        var rs = await fetch(defind_url);
...
var __webpack_exports__ = __webpack_require__.X(0, [381,946,322,784], () => (__webpack_exec__(7276)));
